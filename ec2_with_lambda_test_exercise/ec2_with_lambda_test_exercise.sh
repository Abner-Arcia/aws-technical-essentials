...
key_pair_name=abner-instance-key-pair-lambda
deployment_package_bucket_name=abnerarcia-deployment-package
deployment_package_name=deployment_package
cloudformation_create_script=ec2_with_lambda_test_exercise_create.yml
cloudformation_import_script=ec2_with_lambda_test_exercise_import.yml
cloudformation_bucket_name=cf-templates-1klm480sv15ci-us-east-1
stack_name=ec2-lambda
...
# Create the deployment package, its bucket and upload it
zip $deployment_package_name lambda_function.py

aws s3 mb s3://$deployment_package_bucket_name
aws s3 cp $deployment_package_name.zip s3://$deployment_package_bucket_name
...
aws cloudformation create-stack \
    ...
    --parameters \
        ParameterKey=KeyPairNameParameter,ParameterValue=$key_pair_name \
        ParameterKey=DeploymentPackageBucketNameParameter,ParameterValue=$deployment_package_bucket_name \
        ParameterKey=DeploymentPackageNameParameter,ParameterValue=$deployment_package_name.zip \
...
aws cloudformation create-change-set \
    ...
    --resources-to-import "[{\"ResourceType\":\"AWS::S3::Bucket\",\"LogicalResourceId\":\"DeploymentPackageBucket\",\"ResourceIdentifier\":{\"BucketName\":\"$deployment_package_bucket_name\"}}, \
